...
&#x1F4D7; **Statement: In Q3, the FR query will return more rows than that of NR and M3D queries. This is becasue the dataset has some problems in building the knows graph.**
